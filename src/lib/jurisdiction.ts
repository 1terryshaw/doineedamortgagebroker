...
const JURISDICTIONS: Record<"CA" | "US", Jurisdiction> = {
  ...
  CA: {
    ...
    popularPlaces: [
      { href: "/directory?region=ON", label: "Ontario" },
      { href: "/directory?region=BC", label: "British Columbia" },
      { href: "/directory?region=QC", label: "Quebec" },
      { href: "/directory?region=AB", label: "Alberta" },
      { href: "/directory?region=NS", label: "Nova Scotia" },
    ],
